//Write a non-member method named bagScaler, which
//removes from a Bag all elements that occur  N  or 
//more times. The method returns the number of copies removed.
//
//For example, if B = {Bob, Joe, Bob, Ned, Bob, Ned, Kim}, 
//then calling BagScaler(B,2) removes Bob and Ned making 
//B = {Joe, Kim}, and returns 5.
