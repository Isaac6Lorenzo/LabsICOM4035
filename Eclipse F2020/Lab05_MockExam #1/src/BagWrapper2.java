//Write a non-member method removeDuplicates. This method
//receives as parameter  a Bag B. It removes all duplicates
//from the bag B, leaving only one copy of each element. 
//The method returns the number of duplicates removed.
//
