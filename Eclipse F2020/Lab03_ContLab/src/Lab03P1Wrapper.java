//Consider a member method for the Bag ADT called moreFrequentThan(). T
//his method  returns a new Bag with the items that are more frequent 
//(i.e., the count is larger) than an item obj in the bag instance. T
//he prototype for the method is a follows:
//
//public Bag moreFrequentThan(E e)
//
//This method DOES NOT adds duplicate entries in the resulting Bag. 
//If the argument is not found, then all members of the bag are more 
//frequent than the parameter, and must be returned. If the bag is 
//empty, the result is also an empty Bag.
//
//Implement this method for the DynamicBag class.
...
//        }
        ...
        public Bag moreFrequentThan(Object obj) {
    		...
    		if (!this.isMember(obj)) {
        		...
        		for (Object o : array) {        			
        			if (!bag.isMember(o) && (this.count(o) > this.count(obj))) {
            				bag.add(o);
        			}
        		}
        		return bag;
