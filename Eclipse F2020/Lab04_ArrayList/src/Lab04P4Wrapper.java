//Consider a non-member static method called totalCount(). T
//his method receives two parameters: 
//
//A String s
//An array of objects containing a List<String> in each entry.
//The method totalCount() finds the total number of copies of string s 
//in all the lists in the array. Implement method totalCount()
...
//        return false;
    ...
    public static int totalCount(String s, List<String>[] array) {
    	...
    	for (int i = 0; i < array.length; i++) {
			Iterator<String> it = array[i].iterator();
			while(it.hasNext()) {
				String str = it.next();
				if (str.equals(s)) {
					count++;
