//Consider a member method reverse() for the List<E> ADT that returns
//a new List with the elements in reversed order. 
//
//For example if a List L = {Bob, Mel, Ron, Jil, Ron}, 
//then a call to L.reverse() will return a new list 
//		M = {Ron, Jil, Ron, Mel, Bob}. The old list L 
//		is NOT affected nor modified. The method returns 
//		an empty list if the list L is empty.
//
//The prototype for the method is a follows:
//
//public List<E> reverse()
//
//Implement this method for the ArrayList<E> class. 
...
//			}
		...
		public List<E> reverse() {
			//ADD YOUR CODE HERE
			List<E> newList = new ArrayList<E>(1);
			if (this.isEmpty()) {
				return newList;
			}
			...
			for (int i = 0; i < list2.length; i++) {
				newList.add((E) list2[i]);
			}
			
			return newList; //Dummy Return, delete this when implementing your answer
		}
