//Write a member method changeOddEven which takes all 
//elements in odd positions in the this list and moves 
//them after all the even elements in the list. 
//The relative order between the odd elements is maintained. 
//The same applies to the even elements. Remember that
//the first position is 0 which is considered even. 
//For example, if L = {Bob, Ned, Jil, Amy, Kim} 
//then L.changeOddEven() turns L into L = {Bob, Jil, Kim, Ned, Amy}.
//
//A tester can be found in this link. 
//https://online.upr.edu/pluginfile.php/1297446/question/questiontext/1130382/4/15371467/P1WrapperTesterFinal3.java
...
public class P2Wrapper {
	...
	public static class SinglyLinkedList<E> implements List<E> {
		...
		public void changeOddEven() {
			// ADD YOU CODE HERE
			List<E> list = new SinglyLinkedList<E>();
			int index = 0;
			Iterator<E> it = this.iterator();
			while(it.hasNext()){
//				E obj = it.next();
				System.out.println("index string: " + index + " , " + it.next());
				if (index % 2 != 0) {
					E str = this.remove(index);
...
//			}
		...
		public static void printMe(List list) {
