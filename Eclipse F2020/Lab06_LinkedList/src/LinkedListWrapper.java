//Consider a member method of the List ADT named addAfter(). 
//This method receives as parameters two objects e and f. 
//The methods adds element f after the first copy of the 
//element e in a list L. Implement the method for the 
//SinglyLinkedList class.
//
//For example, if L = {Ken, Bob, Ron, Apu, Ron}, the 
//L.addAfter("Ron", "Jim")  makes L = {Ken, Bob, Ron, Jim, Apu, Ron}. 
...
public class LinkedListWrapper {
	...
	public static class SinglyLinkedList<E> implements List<E> {
		...
		public void addAfter(E e, E f) {
			// ADD YOUR CODE HERE
			int index = this.firstIndexOf(e);
			if(index != -1) {
				Node<E> current = this.getPosition(index);
				Node<E> next = current.getNext();
				Node<E> newNode = new Node<E>(f, next);
