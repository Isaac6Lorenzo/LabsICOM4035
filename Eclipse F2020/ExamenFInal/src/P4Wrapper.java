...
public class P4Wrapper {
	...
	/*
	 * Write a non-member method named findNSmallestValues. This method finds the N smallest values in a
	 * Java array list of integers. The method receives as parameter the array list with the original integer 
	 * data, and the number N. It returns an array list the N smallest values, ORDERED from smallest to largest.  
	 * Hint: Use a Binary Search Tree to organize the data.
	 */
	public static ArrayList<Integer> findNSmallestValues(ArrayList<Integer> data, int N){
		//ADD CODE HERE
...
//		Arrays.sort(array);
		ArrayList<Integer> list = new ArrayList<Integer>(N);
		 BinarySearchTree<Integer, Integer> binaryList = new 
				 BinarySearchTree<Integer, Integer>(new IntegerComparator());
		 for(int i=0; i<data.size(); i++) {
			 Integer num = data.get(i);
			 binaryList.put(num, num);
		 }
		 
		 List<Integer> listKey = binaryList.getKeys();
